import game.IAgent;
import game.Sokoban;
import game.SokobanResult;
import game.SokobanResultType;

public class MyAgentTest {

    public static void main(String[] args) {
        var agent = new MyAgent();
        var levelset = "Aymeric_Medium.sok";
        var timeout = 10000;
        var verbose = false;
        var optimal = true;


        var resultType = runLevel(
                agent, null, levelset, 0, null, timeout, verbose, optimal);
